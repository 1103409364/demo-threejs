...
function addGui() {
  ...
  meshStandardMaterialFolder.add(material, "roughness", 0, 1); // 粗糙度
  meshStandardMaterialFolder.add(material, "metalness", 0, 1); // 金属度
...
export const pageInfo = { title: "MeshStandardMaterial" };
