...
// const bumpTexture = new TextureLoader().load(getImg("earth_normalmap_8192x4096", "jpg"));
// material.bumpMap = bumpTexture; // 凹凸贴图
// material.bumpScale = 0.015;

const normalTexture = new TextureLoader().load(getImg("earth_normalmap_8192x4096", "jpg"));
...
export const pageInfo = { title: "NormalMap" };
