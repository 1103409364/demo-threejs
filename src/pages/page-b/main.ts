...
const matcapTexture = new TextureLoader().load(getImg("matcap-opal"));
// const matcapTexture = new TextureLoader().load(getImg("matcap-crystal"));
// const matcapTexture = new TextureLoader().load(getImg("matcap-gold"));
// const matcapTexture = new TextureLoader().load(getImg("matcap-red-light"));
// const matcapTexture = new TextureLoader().load(getImg("matcap-green-yellow-pink"));
...
export const pageInfo = { title: "MeshMatcapMaterial" };
